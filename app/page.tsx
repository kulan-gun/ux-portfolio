...
export default function HomePage() {
  ...
  const phrases = ["I'm a Product Designer...", "I'm a UX Engineer...", "I'm a Senior Consultant..."]
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <section className="py-16 md:py-24" ref={heroRef}>
            <div className="space-y-4">
              ...
              <p className="sr-only">I'm a Product Designer, UX Engineer, and Senior Consultant.</p>
            </div>
          </section>
